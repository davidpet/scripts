...
" TODO: add more detailed information about source and modifications here
" (most importantly, restored the white background as in Visual Studio because
" the grey one was way too low contrast) [just did find-and-replace for
" f2f2f2 as guibg]
"
...
hi LineNr       guifg=#2b91af   guibg=white gui=none
...
hi NonText      guifg=#bebebe   guibg=white
...
hi Special      guifg=#666600   guibg=white
...
set guifont=Consolas:h11 "using VS Consolas instead of Powerline one
